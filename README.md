...
libraryDependencies += "com.supersonic" %% "kafka-snow-white-consul-app" % "1.2.1"
libraryDependencies += "com.supersonic" %% "kafka-snow-white-file-watcher" % "1.2.1"

// If you want only the basic mirroring functionality with no backing mechanism
libraryDependencies += "com.supersonic" %% "kafka-snow-white-core" % "1.2.1"

// If you want to create a new backend for mirroring
libraryDependencies += "com.supersonic" %% "kafka-snow-white-app-common" % "1.2.1" 
```
